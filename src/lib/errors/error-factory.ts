...
export class ErrorFactory {
  ...
  static validation = {
    ...
    invalidFormat: (
      ...
      new ValidationErrors.InvalidFormatError(
        field,
        expectedFormat,
        actualValue,
        context,
    ...
    outOfRange: (
      ...
      new ValidationErrors.ValueOutOfRangeError(
        field,
        min,
        max,
        actualValue,
  ...
  static business = {
    ...
    concurrentModification: (
      ...
      new BusinessErrors.ConcurrentModificationError(
        resourceType,
        resourceId,
        expectedVersion,
        actualVersion,
    ...
    quotaExceeded: (
      ...
      new BusinessErrors.QuotaExceededError(
        quotaType,
        limit,
        current,
        resetAt,
    ...
    invalidStateTransition: (
      ...
      new BusinessErrors.InvalidStateTransitionError(
        entityType,
        currentState,
        attemptedState,
        allowedStates,
    ...
    preconditionFailed: (
      ...
      new BusinessErrors.PreconditionFailedError(
        precondition,
        message,
        context,
      ),
    ...
    postconditionFailed: (
      ...
      new BusinessErrors.PostconditionFailedError(
        postcondition,
        message,
        context,
      ),
    ...
    dependency: (
      ...
      new BusinessErrors.DependencyError(
        dependency,
        operation,
        reason,
        context,
  ...
  static system = {
    ...
    unavailable: (
      ...
      new SystemErrors.ServiceUnavailableError(
        service,
        reason,
        estimatedDowntime,
        context,
    ...
    webhookFailed: (
      ...
      new SystemErrors.WebhookFailedError(
        url,
        event,
        attempts,
        lastError,
    ...
    emailFailed: (
      ...
      new SystemErrors.EmailSendFailedError(
        recipient,
        subject,
        reason,
        context,
    ...
    circuitBreakerOpen: (
      ...
      new SystemErrors.CircuitBreakerOpenError(
        service,
        failureCount,
        threshold,
        resetAfter,
    ...
    resourceExhausted: (
      ...
      new SystemErrors.ResourceExhaustedError(
        resource,
        limit,
        current,
        context,
