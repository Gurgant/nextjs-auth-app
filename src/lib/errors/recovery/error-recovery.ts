  ...
  return function (
    ...
    descriptor.value = async function (...args: any[]) {
      try {
        ...
        const strategyList = typeof strategies === 'function' ? strategies() : strategies
...
export class RecoveryPatterns {
  ...
  static externalApi<T>(
    ...
    return [
      new CircuitBreakerRecoveryStrategy(operation, 5, 60000, fallback)
    ]
  }
  ...
  static cached<T>(
    ...
    return [
      new CacheRecoveryStrategy(getCacheKey, ttl)
    ]
  }
