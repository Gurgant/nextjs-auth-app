...
export interface SuspiciousActivityPayload {
  userId?: string
  activityType: 'multiple_failed_logins' | 'unusual_location' | 'brute_force' | 'session_hijacking' | 'invalid_token'
...
export interface LoginFailedPayload {
  email: string
  reason: 'invalid_credentials' | 'account_locked' | 'account_disabled' | 'email_not_verified'
...
export class SuspiciousActivityEvent extends BaseEvent<SuspiciousActivityPayload> {
  ...
  constructor(payload: SuspiciousActivityPayload, metadata?: Partial<EventMetadata>) {
...
export class AccountLockedEvent extends BaseEvent<AccountLockedPayload> {
  ...
  constructor(payload: AccountLockedPayload, metadata?: Partial<EventMetadata>) {
    super(payload, metadata)
  }
}
...
export class AccountUnlockedEvent extends BaseEvent<AccountUnlockedPayload> {
  ...
  constructor(payload: AccountUnlockedPayload, metadata?: Partial<EventMetadata>) {
    super(payload, metadata)
  }
}
...
export class RateLimitExceededEvent extends BaseEvent<RateLimitExceededPayload> {
  ...
  constructor(payload: RateLimitExceededPayload, metadata?: Partial<EventMetadata>) {
    super(payload, metadata)
  }
}
...
export class UnauthorizedAccessEvent extends BaseEvent<UnauthorizedAccessPayload> {
  ...
  constructor(payload: UnauthorizedAccessPayload, metadata?: Partial<EventMetadata>) {
    super(payload, metadata)
  }
}
...
export class SecurityAlertEvent extends BaseEvent<SecurityAlertPayload> {
  ...
  constructor(payload: SecurityAlertPayload, metadata?: Partial<EventMetadata>) {
    super(payload, metadata)
  }
}
