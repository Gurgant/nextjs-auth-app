            ...
            {showCredentials ? (
              <div className="space-y-6">
                <div className="text-center">
                  <h3 className="text-xl font-semibold text-gray-900 mb-2">{tAuth('signInToAccount')}</h3>
                  <p className="text-gray-600 text-sm">{tAuth('enterCredentials')}</p>
                </div>
                <CredentialsForm />
                <div className="relative">
                  ...
                  <div className="relative flex justify-center text-sm">
                    <span className="px-4 bg-white text-gray-500 font-medium">{tAuth('or')}</span>
                  </div>
                </div>
                <button
              ...
              <div className="space-y-6">
                <div className="text-center">
                  <h3 className="text-xl font-semibold text-gray-900 mb-2">{tAuth('welcomeBack')}</h3>
                  <p className="text-gray-600 text-sm">{tAuth('chooseSignInMethod')}</p>
                </div>
                <SignInButton />
                <div className="relative">
                  <div className="absolute inset-0 flex items-center">
