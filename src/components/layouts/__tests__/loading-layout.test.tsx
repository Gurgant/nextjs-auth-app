...
describe("LoadingLayout", () => {
  it("renders with default props", () => {
    const { getByText, getByTestId } = render(<LoadingLayout />);
  ...
  it("renders without message when message is empty", () => {
    const { queryByText } = render(<LoadingLayout message="" />);
  ...
  it("applies fullScreen layout", () => {
    const { container } = render(<LoadingLayout fullScreen />);
  ...
  it("passes custom spinnerSize", () => {
    const { getByTestId } = render(<LoadingLayout spinnerSize="xl" />);
  ...
  it("merges custom className", () => {
    const { container } = render(<LoadingLayout className="bg-blue-100" />);
  ...
  it("has correct text styling for message", () => {
    const { getByText } = render(<LoadingLayout message="Test message" />);
