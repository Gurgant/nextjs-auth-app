...
describe("AlertMessage", () => {
  ...
  it("renders warning alert correctly", () => {
    ...
    expect(screen.getByText("Please be careful")).toHaveClass(
      "text-yellow-700",
    );
  });
  ...
  it("renders info alert correctly", () => {
    ...
    expect(screen.getByText("For your information")).toHaveClass(
      "text-blue-700",
    );
  });
  ...
  it("displays field errors when provided", () => {
    ...
    render(
      <AlertMessage type="error" message="Validation failed" errors={errors} />,
    );
  ...
  it("does not show errors section when errors object is empty", () => {
    render(<AlertMessage type="error" message="Error occurred" errors={{}} />);
