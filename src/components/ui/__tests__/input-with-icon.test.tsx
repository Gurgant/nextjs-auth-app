...
describe("InputWithIcon", () => {
  it("renders email input with mail icon", () => {
    render(
      <InputWithIcon icon="mail" type="email" placeholder="Enter email" />,
    );
  ...
  it("renders user input with user icon", () => {
    render(<InputWithIcon icon="user" type="text" placeholder="Enter name" />);
  ...
  it("shows error state correctly", () => {
    ...
    render(<InputWithIcon icon="mail" type="email" error={errorMessage} />);
  ...
  it("renders with visually hidden label", () => {
    render(<InputWithIcon icon="mail" label="Email Address" srOnlyLabel />);
  ...
  it("applies custom className", () => {
    render(<InputWithIcon icon="mail" className="custom-class" />);
  ...
  it("handles disabled state", () => {
    render(<InputWithIcon icon="mail" disabled placeholder="Disabled input" />);
  ...
  it("uses provided ID when specified", () => {
    render(<InputWithIcon icon="mail" id="custom-email-input" />);
