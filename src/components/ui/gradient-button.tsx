...
interface GradientButtonProps extends ButtonHTMLAttributes<HTMLButtonElement> {
   ...
   * @default 'blue-purple'
   */
  variant?: 'blue-purple' | 'green-emerald' | 'yellow-orange' | 'red' | 'blue' | 'green';
...
const variantClasses = {
  ...
  'yellow-orange': 'from-yellow-600 to-orange-600 hover:from-yellow-700 hover:to-orange-700 focus:ring-yellow-500',
  ...
  'green': 'from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 focus:ring-green-500',
} as const;
