  ...
  // Global configuration - RELAXED RULES
  {
    ...
    rules: {
      ...
      "@typescript-eslint/no-unused-vars": ["warn", { 
        argsIgnorePattern: "^_|^(error|request|params|router|response|result|locale|entry|provider|providerAccountId)$",
        varsIgnorePattern: "^_|^(error|getSafeLocale|t|tCommon|signIn|redirect|notFound|auth|useRef|ActionResult|setupTwoFactorAuth|enableTwoFactorAuth|router|resetProfileForm|response|result|ActionResponse|prisma|ErrorSeverity|PasswordChangedEvent|UserLoggedOutEvent|PrismaClient|windowTime|UpdateUserDTO|locale|entry)$",
