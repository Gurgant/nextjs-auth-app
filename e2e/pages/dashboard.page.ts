...
export class DashboardPage extends BasePage {
  ...
  async waitForDashboardLoad() {
    ...
    await Promise.race([
      this.page
        .waitForSelector(this.selectors.welcomeMessage, { timeout: 5000 })
        .catch(() => null),
      this.page
        .waitForSelector(this.selectors.userName, { timeout: 5000 })
        .catch(() => null),
      this.page
        .waitForSelector("text=Dashboard", { timeout: 5000 })
        .catch(() => null),
    ]);
  }
